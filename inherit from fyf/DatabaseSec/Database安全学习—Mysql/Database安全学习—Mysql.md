...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/1.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/2.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/5.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/6.png]]

```sql
select * from users join catfishblog_users using(id);
```

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/7.png]]

```sql
select * from users,catfishblog_users where users.id = catfishblog_users.id;
```

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/8.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/9.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/10.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/11.png]]

然后可以引用这个已知的别名来获得数据, 需要注意的是对于`select 数字`时, 数字需要加上反引号(后面的命令中没加是为了书写文档方便): `select 2 from (select 1,2,3 union select * from users)x;`.

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/12.png]]

当反引号被`ban`的时候可以使用别名: `select a from (select 1,2 a,3 union select * from users)x;`.

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/13.png]]

或者使用双引号: `select a from (select 1,"a",3 union select * from users)x;`.

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/14.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/15.png]]

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/16.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/3.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/4.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/17.png]]

![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/18.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/19.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/20.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/21.png]]
...
![[H3God Blog/Security-Learning-main/DatabaseSec/Database安全学习—Mysql/images/22.png]]
